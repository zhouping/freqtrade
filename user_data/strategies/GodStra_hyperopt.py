...
# 常用技术指标列表（从 GodStraHo 的 GodGenes 中选取）
INDICATOR_LIST = [
    # 动量指标
    'momentum_rsi', 'momentum_stoch', 'momentum_stoch_rsi', 'momentum_tsi',
    'momentum_uo', 'momentum_stoch_signal', 'momentum_wr', 'momentum_ao',
    'momentum_kama', 'momentum_roc', 'momentum_ppo', 'momentum_ppo_hist',
    # 趋势指标
    'trend_macd', 'trend_macd_signal', 'trend_macd_diff', 
    'trend_sma_fast', 'trend_sma_slow', 'trend_ema_fast', 'trend_ema_slow',
    'trend_adx', 'trend_adx_pos', 'trend_adx_neg', 'trend_trix',
    'trend_cci', 'trend_aroon_up', 'trend_aroon_down', 'trend_aroon_ind',
    # 成交量指标
    'volume_mfi', 'volume_adi', 'volume_obv', 'volume_cmf', 'volume_vwap',
    # 波动率指标
    'volatility_atr', 'volatility_bbh', 'volatility_bbl', 'volatility_bbw',
]

class GodStra_hyperopt(IStrategy):
    # 支持 --spaces all 优化的版本
